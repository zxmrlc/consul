...
type configSnapshotConnectProxy struct {
	...
	// Intentions note this is a list of lists as returned by Match RPC. So far
	// we only use the first list as the list of matching intentions.
	//
	// TODO(rbac-ixns): should this show up in Valid()?
...
func (s *ConfigSnapshot) Valid() bool {
	...
	case structs.ServiceKindConnectProxy:
		...
		return s.Roots != nil && s.ConnectProxy.Leaf != nil && s.ConnectProxy.IntentionsSet
